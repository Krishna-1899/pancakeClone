...
function DarkModeToggle({ onToggle, darkMode, footer }) {
  function toggle() {
    onToggle(!darkMode);
  }
  ...
  return (
    <div
      onClick={handleClick}
      className={`cursor-pointer w-[56px]  h-[32px]  z-[5] ${
        footer ? "bg-[#666171]" : darkMode ? "bg-[#666171] " : " bg-[#bdc2c4]"
      } rounded-full relative px-1 flex items-center abc `}
    >
      <div
        className={`w-[26px] h-[26px] rounded-full absolute transform z-[7] duration-200 ease-out ${
          darkMode ? " bg-[#27262c]" : "bg-white"
        } left-0.5 ${darkMode ? "translate-x-6" : "translate-x-0"} bcd`}
      />
      {darkMode ? (
        <div className="flex justify-between items-center gap-[6px] z-[10] ">
          <div className=" flex ">
            <svg
              viewBox="0 0 24 24"
        ...
        <div className="flex justify-between items-center gap-[6px]  z-[10]  ">
          <div className="flex">
            <svg
              className="h-[20px] w-[20px] text-[yellow]  left-0"
              viewBox="0 0 24 24"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
